...
public class TemporaryFeedback {

    private final String _htmlFieldName;
    private final String _htmlFieldType;
    private final String _errorMessage;

    public TemporaryFeedback(String htmlFieldName, String htmlFieldType) {
        this(htmlFieldName, htmlFieldType, null);
    }

    public TemporaryFeedback(String htmlFieldName, String htmlFieldType, String errorMessage) {
